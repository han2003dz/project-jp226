...
function generatePass(len){
  ...
  // }
  // // gán vào 2 ô
  // document.getElementById('inputNewPassWord').value = pass;
  // document.getElementById('inputConfirmPass').value = pass;
  let str = '1234567890qwertyuiopasdfghjklzxcvbnmQƯERTYUIOPASDFGHJKLZXCVBNM~!@#$%^&*()_+<>?:;[]';
  let pass = '';
  for(var i = 1; i < len; i++){
    pass += str.charAt(Math.floor(Math.random() * str.len))
  }
}
...
// Example usage: generate a random password with length 8
var password = generatePassword(8);
console.log(password); // e.g. "3qJiC6zX"
