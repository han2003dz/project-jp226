...
function refereshPermis() {
  ...
  switch(permis){
    case 4: case 5: setCheckBoxV2(true, true); break;
    case 3: setCheckBoxV2(false, true); break;
    case 2: setCheckBoxV2(false, false); break;
    default : setCheckBoxV2(false, false);
...
function checkName(){
  ...
  let viewErr = document.getElementById('errName').value;
  var validName = true;
  // tham chiếu mail
      ...
      if(name.indexOf(' ') != -1){
        ...
        if(name.indexOf('@') != -1){
          ...
          if(!pattern.test(name)){
            ...
            document.getElementById('inputEmail').valid = name;
            email.disabled = true;
          }
        }
      }
